...
?>
<form action="<?php echo base_url('sk/updatesk/'.$surat['id_sk']);?>" method="post" enctype="multipart/form-data" >


<div class="col-md-6">
    <div class="form-group">
        <label>Tujuan</label>
        <input type="text" name="tujuan" placeholder="Pengirim Surat" value="<?php echo $surat['tujuan'] ?>" required class="form-control">
    </div>
   ...
   <div class="form-group">
        ...
        <img src="<?php echo base_url('assets/upload/image/suratkeluar/'.$surat['file'])?>" style="position: absolute;height: 150px;width: 150px;margin-left: 5px;">
    </div>
</div>
<div class="col-md-6">
<div class="form-group">
    ...
    <div class="form-group">
        ...
        <textarea name="pesan" placeholder="Isi Ringkas Surat" required class="form-control" id="tex"><?php echo $surat['isi_ringkas']?></textarea>
    </div>
    </div>
