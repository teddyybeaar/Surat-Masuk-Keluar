...
<form action="<?php echo base_url('surat/xx') ?>" method="post" enctype="multipart/form-data">
...
<div class="col-md-6">
    <div class="form-group">
        <label>Dari*</label>
        <input type="text" name="dari" placeholder="Pengirim Surat" required class="form-control">
    </div>
	<div class="form-group">
